...
<body>
  ...
  <form  method='post' action="login.php">
  	<br>
  	<input type='text' id= 'user' required name='username' class = "form-control" placeholder="Username" style="width: 20em; height: 3em;">
  	<br>
  	<input type="password" id = 'pass' name="password" class="form-control" placeholder="Password" required style="width: 20em; height: 3em;">
  	
  	<br>
  	<button class="btn btn-lg btn-primary btn-block" type="submit" name = 'submit' value="login"
  		style="width: 20em; height: 3em;">Sign in</button>
